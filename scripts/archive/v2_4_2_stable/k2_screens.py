...
class ResultsScreen(BaseScreen):
    ...
    def __init__(self, parent, app):
        ...
        v_ctrl.pack(fill='x', padx=5, pady=5)
        ...
        self.pca_label.pack(fill='both', expand=True, padx=10, pady=10)
        ...
        self.heatmap_label.pack(fill='both', expand=True, padx=10, pady=10)
        ...
        self.boxplot_label.pack(fill='both', expand=True, padx=10, pady=10)
    ...
    def update_feature_boxplot(self, match):
        ...
        try:
            ...
            self._display_image(path, self.boxplot_label, (500, 400))
