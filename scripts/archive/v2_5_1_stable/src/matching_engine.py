...
class MatchingEngine:
    def __init__(self, data_dir, quant_file, msp_file, library_file, ri_cal_file=None, blank_identifier="fieldblank", sample_types=None):
    ...
    def load_data(self):
        ...
        # 4. Run BFF (Pre-requisite for matching)
        print("Running BFF Filter...")
