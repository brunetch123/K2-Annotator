...
class K2Application(tk.Tk):
    ...
    def init_screens(self):
        ...
        # Sample Classification (v2.7.0: simplified from grouping)
        self.screens['sample_grouping'] = SampleClassificationScreen(self.main_container, self)

        # Internal Standard Normalization (v2.6.0)
        self.screens['internal_standard'] = InternalStandardScreen(self.main_container, self)
