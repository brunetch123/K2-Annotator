...
class K2Application(tk.Tk):
    ...
    def __init__(self):
        ...
        logo_path = get_resource_path("K2Icon.png")
        if logo_path.exists():
            try:
    ...
    def init_screens(self):
        ...
        # Sample Classification & Internal Standard (v2.8.0: integrated IS into sample classification)
        self.screens['sample_grouping'] = SampleClassificationScreen(self.main_container, self)
        ...
        # Surrogate Standard Configuration (v3.0.0)
        self.screens['surrogate_config'] = SurrogateConfigScreen(self.main_container, self)
...
from k2_screens import (
    ...
    EntrySelectScreen,
    ProjectSetupScreen,
    SampleClassificationScreen,
    MSConvertScreen,
    MZmineScreen,
    AnalysisParamsScreen,
    SurrogateConfigScreen,  # v3.0.0
    ExecutionScreen,
    ResultsScreen
)
